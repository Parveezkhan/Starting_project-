...
//ec2 instance
const azure_ml_ginstance=['D2 v3',
   ' D4 v3',
    'D8 v3',
    'D16 v3',
    'D32 v3',
...
//ec2 storage
const azure_ml_category =['General purpose',
    'D2-64 v3'
    ]

//rds_instance
const azure_openai_model=[
    'Realtime API',
    "Chat Completions API"
]
//red_vcpu
const azure_openai_vcpu=[
  '2 vcpu',
  '4 vcpu',
  '8 vcpu'
]
    ...
    <>
        ...
        >
          {Vcpu.map((name) => (
            ...
            <div className='col-12 col-ms-12 col-md-12 col-lg-4 '><div className='instance '>
            <FormControl sx={{ m: 1, width: 300 }} >
        <InputLabel id="demo-multiple-name-label">GInstance</InputLabel>
        <Select
          className='w-100'
          labelId="demo-multiple-name-label"
          id="demo-multiple-name"
